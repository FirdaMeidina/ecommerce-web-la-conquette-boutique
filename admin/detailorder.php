...
$invoices = mysqli_real_escape_string($conn, $_GET['inv']);
                ...
                <tr>
                    ...
                    <td>
                        <?php if($row['tolak'] == 0 && $row['cek'] == 1 && $row['terima'] == 0) { ?>
                            <a href="inventory.php?cek=0" id="rq" class="btn btn-warning"><i class="glyphicon glyphicon-warning-sign"></i> Request Kekurangan Material</a> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-striped">
                        ...
                        <tr>
    <td>Catatan</td>
    <td><?= isset($t_order['catatan']) ? $t_order['catatan'] : ''; ?></td>
</tr>
                    ...
                    <table class="table table-striped">
                        ...
                        ?>
                        <tr>
                            <td colspan="7" class="text-right"><b>Grand Total = Rp.<?= number_format($grand, 0, ".", "."); ?></b></td>
                        </tr>
                    </table>
                </div>
