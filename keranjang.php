	...
	<table class="table table-striped">
		...
		if(isset($_SESSION['user'])){
			...
			if($jml > 0){
				...
				<tr>
					<td colspan='8' class='text-center bg-warning'><h5><b>KERANJANG BELANJA ANDA KOSONG</b></h5></td>
				</tr>
				";
			}
		}else{
			echo "<tr>
			<td colspan='8' class='text-center bg-danger'><h5><b>LOGIN DULU YAA SEBELUM BELANJA!</b></h5></td>
			</tr>";
		}
		?>
		</tbody>
