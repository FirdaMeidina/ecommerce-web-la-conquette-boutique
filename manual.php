	...
	<div class="bs-acc">
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="color:#ff8680;">
				<div class="panel-heading" style="background-color: rgb(255, 221, 229);">
					<h4 class="panel-title">
						Bagaimana Cara Berbelanja di  La Conquette Butik ?
					</h4>
				</div>
				</a>
